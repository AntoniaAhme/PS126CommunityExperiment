...
meta_sig <- c('temperature','Chla', 'POC', 'C:N', 'Silicate', 'D2', 'RichnessE', 'EvennessE', 'RichnessP', 'EvennessP')
...
RDA_plot_cons <- ggplot(data=sites.long, 
    ...
    geom_segment(data=subset(vectors.long, vector %in% c('Chla', 'POC', 'C:N', 'Silicate', 'D2', 'RichnessE', 'EvennessE', 'RichnessP', 'EvennessP')),
                 aes(x=0, y=0, xend=axis1*3, yend=axis2*3), 
                 lineend = 'round', linejoin = 'bevel',
                 colour="black", size=0.705, arrow=arrow(length = unit(0.2,"cm"))) +
    geom_text_repel(data=subset(vectors.long, vector %in% c('Chla', 'POC', 'C:N', 'Silicate', 'D2', 'RichnessE', 'EvennessE', 'RichnessP', 'EvennessP')), 
